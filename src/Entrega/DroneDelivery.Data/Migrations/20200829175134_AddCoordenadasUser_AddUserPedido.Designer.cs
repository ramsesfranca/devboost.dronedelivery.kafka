...
namespace DroneDelivery.Data.Migrations
{
    ...
    [Migration("20200829175134_AddCoordenadasUser_AddUserPedido")]
    partial class AddCoordenadasUser_AddUserPedido
    {
            ...
            modelBuilder.Entity("DroneDelivery.Domain.Entidades.Pedido", b =>
                {
                    ...
                    b.HasOne("DroneDelivery.Domain.Entidades.User", "User")
                        .WithMany("Pedidos")
